...
<title>ScholarLink — Saved Scholarships</title>
...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <a class="sb-nav-item active" href="{{ route('applicant.saved') }}">
      ...
      Saved
      @if(isset($savedScholarships) && $savedScholarships->count() > 0)
      <span class="sb-badge-transparent">{{ $savedScholarships->count() }}</span>
      @endif
    </a>
