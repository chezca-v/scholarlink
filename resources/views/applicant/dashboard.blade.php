...
<title>ScholarLink — Applicant Dashboard</title>
...
<div class="app">
  ...
  <aside class="sidebar">
    ...
    <form method="POST" action="{{ route('logout') }}" style="margin:0;">
        @csrf
        <button @click="$dispatch('open-modal', 'confirm-logout') type="submit" class="sb-nav-item text-red-600 hover:bg-red-50" style="width:100%; border:none; background:transparent; text-align:left;" >
